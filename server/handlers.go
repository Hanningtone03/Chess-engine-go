...
func buildState(b *board.Board) StateResponse {
	legal := b.LegalMoves()
...
func StateHandler(store *GameStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		writeJSON(w, http.StatusOK, buildState(game.Board))
	}
}
...
func MoveHandler(store *GameStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		writeJSON(w, http.StatusOK, MoveResponse{Move: chosen.String(), State: buildState(game.Board)})
	}
}
...
func EngineMoveHandler(store *GameStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		writeJSON(w, http.StatusOK, MoveResponse{Move: result.BestMove.String(), State: buildState(game.Board)})
	}
}
